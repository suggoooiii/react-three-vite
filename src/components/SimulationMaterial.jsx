import simulationVertexShader from "../glsl/simulationVertexShader.glsl";
import simulationFragmentShader from "../glsl/simulationFragmentShader.glsl";
...
class SimulationMaterial extends THREE.ShaderMaterial {
  constructor(size) {
    const positionsTextureA = new THREE.DataTexture(getRandomDataSphere(size, size), size, size, THREE.RGBAFormat, THREE.FloatType);
    positionsTextureA.needsUpdate = true;

    const positionsTextureB = new THREE.DataTexture(getRandomDataBox(size, size), size, size, THREE.RGBAFormat, THREE.FloatType);
